...
use advanca_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
...
macro_rules! new_full_start {
    ($config:expr) => {{
        ...
        let builder = sc_service::ServiceBuilder::new_full::<
            advanca_runtime::opaque::Block,
            advanca_runtime::RuntimeApi,
        ...
        .with_import_queue(|_config, client, mut select_chain, transaction_pool| {
            ...
            let (grandpa_block_import, grandpa_link) =
                grandpa::block_import::<_, _, _, advanca_runtime::RuntimeApi, _>(
                    client.clone(),
                    &*client,
                    select_chain,
                )?;
